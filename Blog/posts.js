...
const posts = [
  ...
  },
  {
    ...
    description: "The rise of RESTful APIs has been met by a rise of tools for creating, testing and managing them.",
  ...
  },
  {
    ...
    description: "Want the secrets of transforming a 2–14 team into a 3x Super Bowl winning dynasty?",
...
/* ---------- Config ---------- */
const INITIAL_LOAD = 6;   // how many posts to show initially
const LOAD_MORE_BY = 3;   // how many to add on each "Load more"
